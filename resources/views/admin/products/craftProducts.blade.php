          ...
          <section>
            <div class="panel-body borde"><!--busqueda producto-->
              ...
              <div class="row " >
                ...
                <div class="pull-left">
                  <br>
                  <button id="iconSearch" type="button" class="btn btn-primary pull-left" data-toggle="modal" id="first" data-title="Buscar" data-target="#favoritesModalProduct" style="margin-top: 6px;">
